        ...
        <div class="col-12 col-xl-5 col-lg-6">
            <form action="/users" method="get" class="mb-2" id="form-search">
                <div class="input-group">
                    ...
                    <input type="text" name="search" id="search" placeholder="Masukkan nama user atau email"
                        class="form-control" autocomplete="off">
                    <input type="submit" value="Cari" class="btn btn-primary">
                    <a href="/users/new" class="btn btn-outline-info">Tambah</a>
                </div>
            </form>
        </div>
    </div>
    ...
    $(function() {
        ...
        $('.btn-lihat').on("click", function(event) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                success: function(data) {
                    $("#modal-show-item .modal-title").html('Rincian User')
