<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-xl-5 col-lg-6">
            <form action="/customers" method="get" class="mb-2" id="form-search">
                <div class="input-group">
                    <span class="input-group-text fw-bold">Cari Customer</span>
                    <input type="text" name="search" id="search" placeholder="Masukkan nama customer atau email"
                        class="form-control" autocomplete="off">
                    <input type="submit" value="Cari" class="btn btn-primary">
                    <a href="/customers/new" class="btn btn-outline-secondary">Tambah</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="table-result">
        <?= view('customers/_customers', ['customers' => $customers]) ?>
    </div>
    ...
    $(function() {
        ...
        $('.btn-lihat').on("click", function(event) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                success: function(data) {
                    $("#modal-show-item .modal-title").html('Rincian customer')
