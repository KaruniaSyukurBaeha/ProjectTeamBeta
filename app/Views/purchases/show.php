<div class="container">
    ...
    <button type="button" class="btn btn-sm btn-warning mb-2" data-bs-toggle="modal"
        data-bs-target="#modal-add-purchase-item">
        Tambah Purchase Item
    </button>
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= thousand_separator($purchase_item->price) ?></td>
                <td><?= thousand_separator($purchase_item->subtotal) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
                ...
                <div class="modal-body">
                    <form action="/purchaseitems" method="post">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="purchase_id" id="purchase_id" class="form-control"
                                value="<?= $purchase['id'] ?>">
                        </div>
                        <div class="mb-3">
