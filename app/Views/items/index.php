        ...
        <div class="col-12 col-xl-5 col-lg-6">
            <form action="/items" method="get" class="mb-2" id="form-search">
                <div class="input-group">
                    <span class="input-group-text fw-bold">Cari Buku</span>
                    <input type="text" name="search" id="search" placeholder="Masukkan nama buku" class="form-control"
                        autocomplete="off">
                    <input type="submit" value="Cari" class="btn btn-primary">
                    <a href="/items/new" class="btn btn-outline-info">Tambah</a>
                </div>
            </form>
        </div>
    </div>
